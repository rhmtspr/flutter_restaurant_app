...
import 'package:flutter_restaurant_app/style/colors/restaurant_colors.dart';
import 'package:flutter_restaurant_app/style/typography/restaurant_text_styles.dart';

class RestaurantTheme {
  static ThemeData get lightTheme {
    return ThemeData(
      colorSchemeSeed: RestaurantColors.red.color,
